...
dataset = pd.read_csv(r"C:\Users\Mohammad Faiz\Downloads\framingham.csv")
...
Smoker = st.number_input("Are you a Smoker?  1 for Yes and 0 for No: ")
if(Smoker == 1):
    cigsPerDay = st.number_input("Enter how many cigarettes you consume daily: ")
else:
    cigsPerDay = 0
BP = st.number_input("Enter BP MEDS: ")
PreStroke = st.number_input("Are you with prevalentStroke?  1 for Yes and 0 for No: ")
preHyp = st.number_input("Is your Blood Presure High?  1 for Yes and 0 for No: ")
diabetes = st.number_input("Are you have Diabetes?  1 for Yes and 0 for No: ")
